        ...
        <div class="m-8">
            ...
            <div class="space-y-4">
                ...
                <NearMeCard
                    ...
                    km="50"
                />
                <NearMeCard icon="info" place="vadayar" minute="40" km="45" />
                <NearMeCard icon="info" place="kolukkumala" minute="50" km="54" />
                <NearMeCard icon="info" place="maattupetti" minute="40" km="45" />
            </div>
        </div>
    );
}
