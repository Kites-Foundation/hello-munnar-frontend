    ...
    return (
        <div class="relative flex w-full flex-wrap items-stretch mb-3">
            ...
            <input
                ...
                class="px-3 py-3 placeholder-gray-400 text-black relative bg-white bg-white rounded text-sm border-0 border-b-2 border-gray-400 outline-none focus:outline-none focus:shadow-outline w-full pl-10"
            />
        </div>
    );
};
